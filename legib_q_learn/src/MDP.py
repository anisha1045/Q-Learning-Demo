...
class OrigQTablePolicy():
    ...
    def __init__(self, states, actions_length, total_episodes = 5, steps_per_episode = 5, exploration_rate = 0.7, exploration_decay = 0.05, discount_factor = 0.9, learning_rate = 0.7):
        self.q_table = {}
        self.q_tables = {}
    ...
    def get_action(self, state, task, arm):
        ...
        new_state, tuple = task.take_action(action_index, arm)
...
class ModQTablePolicy(OrigQTablePolicy):
    def __init__(self, states, actions_length, start, grid_dim, total_episodes = 5, steps_per_episode = 5, exploration_rate = 0.7, exploration_decay = 0.05, discount_factor = 0.9, learning_rate = 0.7):
...
if __name__=="__main__":
    ...
    env = Environment(classic_task, robot.Robot())
    mod_policy = ModQTablePolicy(env.states, env.actions_length, classic_task.get_initial_state(), classic_task.grid_dim, num_episodes)
